...
def main():
    ...
    contadores= {"inicio": 1,"Hall predio 2": 0, "sala dos professores":0, "andar do professor":0, "biblioteca": 0, "atendimento dos ninjas": 0, "professor": 0 }
    ...
    while not game_over:
        ...
        if escolha == "lutar":
            ...
            if contadores["inicio"]==2:
                ...
                print()
                print()
            elif contadores["sala dos professores"]==1:
                print()
